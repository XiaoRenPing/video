...
public interface HCNetSDK extends StdCallLibrary {
	...
	String hcNetSdkPath = bundle.getString("dllpath") + "HCNetSDK.dll";    //"D:\\hikvision\\lib\\HCNetSDK.dll";
	
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(hcNetSdkPath, HCNetSDK.class);
...
//JPEG抓图到内存
 ...
 boolean  NET_DVR_CaptureJPEGPicture_Pointer(NativeLong lUserID, NativeLong lChannel, NET_DVR_JPEGPARA lpJpegPara, Pointer p, int dwPicSize,  IntByReference lpSizeReturned);
...
{
	ResourceBundle bundle = ResourceBundle.getBundle("device");
	String playctrl = bundle.getString("dllpath")+"PlayCtrl.dll";
