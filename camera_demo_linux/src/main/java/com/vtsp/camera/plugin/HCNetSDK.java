...
public interface HCNetSDK extends Library {
	...
	String hcNetSdkPath = bundle.getString("hcnetsdk");    //"D:\\hikvision\\lib\\HCNetSDK.dll";
...
{
	ResourceBundle bundle = ResourceBundle.getBundle("device");
	String playctrlPath = bundle.getString("PlayCtrl"); 
    PlayCtrl INSTANCE = (PlayCtrl) Native.loadLibrary(playctrlPath, PlayCtrl.class);
